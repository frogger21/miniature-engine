...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
par(mfrow=c(1,1),cex=1,bg="white")
...
legend("bottomleft",box.lty=1,legend=c("Observed = Y + Gaussian Noise","True Y",paste("centered NN smoother k =",k),"one-sided NN smoother"),col=c("black","red","purple","seagreen4"),lwd=c(NA,2,2,2),pch=c(1,NA,NA,NA))
